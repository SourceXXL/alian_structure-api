...
// Create a type for our mock query builder that includes all methods we use
type MockQueryBuilder = Partial<SelectQueryBuilder<TestEntity>> & {
  select: jest.Mock;
  orderBy: jest.Mock;
  andWhere: jest.Mock;
